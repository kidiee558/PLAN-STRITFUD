...
export default function Hero() {
  const [heroImage, setHeroImage] = useState("https://raw.githubusercontent.com/kidiee558/PLAN-street-food/main/PLAN-sm-produkt-4.jpg");
  const [heroVideo, setHeroVideo] = useState<string | null>(null);

  useEffect(() => {
    client.fetch('*[_type == "pageMedia"][0]{heroImageCircle, "heroVideoUrl": heroVideo.asset->url}')
      .then((data) => {
        if (data?.heroImageCircle) {
          setHeroImage(urlFor(data.heroImageCircle).width(800).url());
        }
